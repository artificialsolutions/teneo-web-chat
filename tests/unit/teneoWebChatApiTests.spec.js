    ...
    if (str) {
      ...
      describe('WebChat components can call API_ON_BUTTON_CLICK', () => {
        ...
        test('API_ON_BUTTON_CLICK triggers callback when ButtonMessage clicked', async()=>{
          ...
          const clickableListCard = {type: "clickablelist", data:{
            title: "Optional title",
            list_items: [{
                    title: "One",
                    postback: "One"
          ...
          const quickreplyMessage = {type: "quickreply", data:{
            title: "Optional title",
            quick_replies: [{
                    title: "One",
                    postback: "One"
